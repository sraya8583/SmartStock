...
function lowStockEmailHtml(product) {
  return `
    <div dir="rtl" style="font-family: Arial, Helvetica, sans-serif; max-width: 420px; margin: 0 auto; padding: 24px; text-align: center; color: #1f2937;">
      ...
      <p style="margin: 0 0 20px; font-size: 0.95rem; color: #4b5563;">המוצר <strong>${product.name}</strong> (מק"ט ${product.sku}) הגיע למלאי של ${product.currentStock} יחידות, הסף שהוגדר (${product.lowStockThreshold}).</p>
